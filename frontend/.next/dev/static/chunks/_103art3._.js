...
const Button = /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["forwardRef"](_c = ({ className, variant, size, asChild = false, ...props }, ref)=>{
    // Se asChild for true, renderiza o Slot do Radix, senão renderiza a tag button normal
...
const API_URL = ("TURBOPACK compile-time value", "http://localhost:5176/api");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/api.ts [app-client] (ecmascript)"); // Importando a instância configurada no passo anterior
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/axios/lib/axios.js [app-client] (ecmascript)");
;
;
async function login(payload) {
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].post('/api/Auth/login', {
            Email: payload.email,
...
function LoginForm() {
    ...
    async function handleSubmit(event) {
        ...
        setIsLoading(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["login"])({
                email,
                password
            });
            router.push('/dashboard');
        } catch (err) {
            setError(err instanceof Error ? err.message : 'N\u00E3o foi poss\u00EDvel entrar. Verifique seus dados e tente novamente.');
        } finally{
            setIsLoading(false);
        }
    }
...
_s(LoginForm, "Bz17uGg0sVJ1ur9DtqOUNxyREQg=", false, function() {
    return [
...
//# sourceMappingURL=_103art3._.js.map